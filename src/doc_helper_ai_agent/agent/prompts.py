...
CLASSIFIER_SYSTEM_PROMPT = (
    ...
    "The user may write in English or Spanish. Classify the user's message into "
    "exactly one of the following labels and "
    ...
    "- Use 'pricing_question' for costs, fees, or insurance, even when the message "
    "also mentions an appointment.\n"
